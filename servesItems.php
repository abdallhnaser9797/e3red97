                ...
                <div class="col-md-3">
                    <?php 
                        if (isset($_SESSION['uid'])) {
                            ...
                            ?>
                            <a href="servesItems.php?do=editItem&itemid=<?=$itemid?>" class="btn btn-lg btn-warning">Edit</a>
                            <a href="servesItems.php?do=deleteItem&itemid=<?=$itemid?>" class="btn btn-lg btn-danger">Delete</a>
                    <?php }?>
