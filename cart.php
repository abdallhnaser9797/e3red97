                        ...
                        <table class="table">
                            ...
                            <?php foreach ($row as $key => $value) {
                                ...
                                <tr>
                                    ...
                                    <td><button class="btn btn-lg btn-danger" onclick="return confirm('Are you sure?')?window.location.href='servesCart.php?action=removeCartItem&id=<?=$value['cart_item_ID']; ?>':false;"><i class="itrash"></i> </button> </td>
                                </tr>
                            <?php }?>
                            <tr>
